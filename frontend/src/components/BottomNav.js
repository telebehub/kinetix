...
const NAV_ITEMS = [
  ...
  { id: "dashboard", label: "AI Model", icon: Brain },
...
export default function BottomNav({ active, onChange }) {
  return (
    <nav
      ...
      className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-slate-100 flex justify-around py-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] z-[100]"
    >
      {NAV_ITEMS.map((item) => {
